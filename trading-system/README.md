...
> **Earlier design, not under active development.** The repo root (`../`) is
> the active project — a fuller implementation with a tested deterministic
> core, a real CLI, and working CI. This tree is kept for reference and for
> its confirm-gated executor design, which some future work here may still
> draw on.
...
The repo root (`../`) holds market-watch, a separate, self-contained ₪100,000
PAPER simulation system — deterministic Python core with tests, a real CLI,
real Claude Code subagents, and its own CI. It supersedes an earlier
...
if this system were ever wired to a real venue. See `../README.md` and
